...
msg_log()
{
  mn="%M"			
	yr="%Y"     
  msg="`date +${yr}%m%d%H${mn}%S` | prepilot.pl | run_generator.sh"
...
export CLASSPATH=${DEPLOYDIR}/bin/downloadGenerator.jar:${DEPLOYDIR}/lib/mysql-connector-java-5.1.13-bin.jar
#export CLASSPATH

#OUTPUT_PATH=${1}
OUTPUT_PATH=/home/randall/bizlistr/DownloadGenerator/BizlistrTopCompanies.csv
...
java -Xms10m -Xmx1000m -Xss256k \
     bizlistr.DownloadGenerator ${OUTPUT_PATH}
